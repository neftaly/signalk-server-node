            ...
            <Col md="6">
              ...
              <CardBody className="p-4">
                  ...
                  <InputGroup className="mb-3">
                    ...
                    <Input name="email" type="text" placeholder="Email" onChange={this.handleInputChange}/>
                  </InputGroup>
                  <InputGroup className="mb-3">
                  ...
                  <InputGroup className="mb-4">
                    <InputGroupAddon><i className="icon-lock"></i></InputGroupAddon>
        <Input name="confirmPassword" type="password" placeholder="Repeat password" onChange={this.handleInputChange}/>
                  </InputGroup>
                ...
                <CardFooter className="p-4">
                  <Row>
                    <Col xs="12" sm="12">
                      <Button color="success" block onClick={this.handleCreate}>Create Account</Button>
                    </Col>
                  </Row>
                 </CardFooter>
                }
